                          ...
                          child: Center(
                            child: !_isEditing
                                ...
                                : Column(
                                    children: [
                                      /*user */ TextFormField(
                                        initialValue: userData['usuario'].toString(),
                                      ...
                                      Row(
                                        children: [
                                          Flexible(
                                            child: TextFormField(
                                              initialValue: userData['nombre'].toString(),
                                          ...
                                          Flexible(
                                            child: /*lastName*/ TextFormField(
                                              initialValue: userData['apellido'].toString(),
                                      ...
                                      const SizedBox(height: 20),
                                      /*phone */ TextFormField(
                                        initialValue: userData['telefono'].toString(),
